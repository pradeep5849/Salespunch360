-- Version Account package pricing through the same billing_prices ledger.
...
WHERE NOT EXISTS (
  ...
  WHERE "role"='ACCOUNT_PACKAGE'::"BillingRole" AND "period"='YEARLY'::"BillingPeriod" AND "currency"='INR' AND "effectiveUntil" IS NULL
);
