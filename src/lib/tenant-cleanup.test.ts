...
function harness({ records = new Map([[A, inventory(A)], [B, inventory(B)]]), lockedInventory, superAdmin = false, lockedSuperAdmin = superAdmin }:
  { records?: Map<string, Inventory>; lockedInventory?: Inventory | null; superAdmin?: boolean; lockedSuperAdmin?: boolean } = {}) {
