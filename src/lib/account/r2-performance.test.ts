...
describe("R2 query/index contracts",()=>{
 ...
 it("sorts R2 after the latest historical Y invariant migration",()=>{
  ...
  expect(migrations.indexOf("20260913100000_y02_y03_tenant_invariants")).toBeLessThan(migrations.indexOf("20260913150000_r2_performance_indexes"));expect(migrations.indexOf("20260913150000_r2_performance_indexes")).toBeLessThan(migrations.indexOf("20260914130000_m1_m2_mobile_web_session_bridge"));
 });
});
