...
export function calculateOrder(managerSeats:number,salesSeats:number,managerPrice:Prisma.Decimal,salesPrice:Prisma.Decimal):{subtotal:Prisma.Decimal;taxAmount:Prisma.Decimal;totalAmount:Prisma.Decimal};
export function calculateOrder(adminSeats:number,managerSeats:number,salesSeats:number,adminPrice:Prisma.Decimal,managerPrice:Prisma.Decimal,salesPrice:Prisma.Decimal):{subtotal:Prisma.Decimal;taxAmount:Prisma.Decimal;totalAmount:Prisma.Decimal};
