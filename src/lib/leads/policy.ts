import type { LeadStage, ManagerType, Role } from "@prisma/client";
...
type Actor={id:string;role:Role;managerType?:ManagerType|null}; type Assignee={id:string;role:Role;managerType?:ManagerType|null;isActive:boolean;managerId:string|null};
...
export type PipelineActor={id:string;companyId:string;role:Role;managerType?:ManagerType|null};
