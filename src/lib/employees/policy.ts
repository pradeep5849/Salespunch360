...
export class EmployeePolicyError extends Error {
  constructor(public readonly code: "NOT_FOUND" | "INVALID_MANAGER" | "MANAGERS_DISABLED" | "LIFECYCLE_BLOCKED" | "SEAT_LIMIT" | "EMAIL_VERIFICATION_REQUIRED" | "COMPANY_PROFILE_REQUIRED" | "MANAGER_TYPE_CONFLICT") {
    super(code);
  }
}
