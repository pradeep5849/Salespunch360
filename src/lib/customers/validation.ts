...
export const createCustomerSchema = z.object({name:customerFields.name,phone:phoneSchema.refine(Boolean,"Phone number is required"),assignedUserId:z.preprocess((value)=>value===""||value===null?undefined:value,z.string().uuid().optional()),branchId:z.preprocess(value=>value===""||value===null?undefined:value,z.string().uuid().optional())}).strict();
