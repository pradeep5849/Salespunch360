...
function field(user:MobilePrincipal){if(user.role==='COMPANY_ADMIN'||(user.role==='MANAGER'&&user.managerType==='MANAGER_ONLY'))throw new MobileFieldError('FORBIDDEN',403);return user}
