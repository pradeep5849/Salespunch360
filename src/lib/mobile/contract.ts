...
export const MOBILE_PUBLIC_ERROR_CODES = [
  ...
  "INVALID_SECTION", "INVALID_REFERENCE", "INVALID_TRANSITION", "INVALID_REPORT",
  ...
  "INVALID_MANAGER", "EMAIL_VERIFICATION_REQUIRED", "COMPANY_PROFILE_REQUIRED",
  ...
  "SUBJECT_OWNERSHIP_CONFLICT", "VISIT_NOT_FOUND",
] as const;
