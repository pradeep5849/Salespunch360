...
beforeEach(()=>{vi.clearAllMocks();mocks.checkIn.mockResolvedValue({id:'visit-a',checkedInAt:new Date()});mocks.customers.mockResolvedValue([{id:'customer-a',companyId:'company-a',name:'Acme',contactPerson:null,phone:null,email:null,address:null,latitude:null,longitude:null,createdAt:new Date(),updatedAt:new Date()}]);mocks.history.mockResolvedValue([])});
