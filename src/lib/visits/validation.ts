...
export const checkoutSchema = z.object({ visitId: z.string().uuid(), branchId, location: requiredGps, sentiment: z.enum(["POSITIVE", "NEUTRAL", "NEGATIVE"]), remarks: optionalNotes }).strict();
