...
export const ACCOUNT_ROLE_PERMISSIONS: Record<AccountRole, readonly Permission[]> = {
  ...
  ACCOUNTANT: ["ACCOUNT_DASHBOARD", "ACCOUNT_QUOTATION_VIEW", "ACCOUNT_QUOTATION_EDIT", "ACCOUNT_QUOTATION_APPROVE", "ACCOUNT_QUOTATION_COST_VIEW", "ACCOUNT_QUOTATION_SHARE", "ACCOUNT_LEDGER_VIEW", "ACCOUNT_JOURNAL_DRAFT", "ACCOUNT_JOURNAL_POST", "ACCOUNT_JOURNAL_REVERSE", "ACCOUNT_OPENING_BALANCE", "ACCOUNT_ACCOUNTS", "ACCOUNT_REPORTS"],
  ...
  DATA_ENTRY: ["ACCOUNT_DASHBOARD", "ACCOUNT_QUOTATION_VIEW", "ACCOUNT_QUOTATION_EDIT", "ACCOUNT_LEDGER_VIEW", "ACCOUNT_JOURNAL_DRAFT", "ACCOUNT_ACCOUNTS", "ACCOUNT_STOCK"],
};
