...
export const PERMISSIONS = [
  ...
  "ACCOUNT_DASHBOARD", "ACCOUNT_LEDGER_VIEW", "ACCOUNT_JOURNAL_DRAFT", "ACCOUNT_JOURNAL_POST", "ACCOUNT_JOURNAL_REVERSE", "ACCOUNT_OPENING_BALANCE", "ACCOUNT_PERIOD_LOCK", "ACCOUNT_CHART_ADMIN", "ACCOUNT_PROJECTS", "ACCOUNT_ACCOUNTS", "ACCOUNT_STOCK", "ACCOUNT_REPORTS", "ACCOUNT_USER_ADMIN", "ACCOUNT_SETTINGS",
] as const;
...
export const ACCOUNT_ROLE_PERMISSIONS: Record<AccountRole, readonly Permission[]> = {
  ACCOUNT_ADMIN: ["ACCOUNT_DASHBOARD", "ACCOUNT_LEDGER_VIEW", "ACCOUNT_JOURNAL_DRAFT", "ACCOUNT_JOURNAL_POST", "ACCOUNT_JOURNAL_REVERSE", "ACCOUNT_OPENING_BALANCE", "ACCOUNT_PERIOD_LOCK", "ACCOUNT_CHART_ADMIN", "ACCOUNT_PROJECTS", "ACCOUNT_ACCOUNTS", "ACCOUNT_STOCK", "ACCOUNT_REPORTS", "ACCOUNT_USER_ADMIN", "ACCOUNT_SETTINGS"],
  ACCOUNTANT: ["ACCOUNT_DASHBOARD", "ACCOUNT_LEDGER_VIEW", "ACCOUNT_JOURNAL_DRAFT", "ACCOUNT_JOURNAL_POST", "ACCOUNT_JOURNAL_REVERSE", "ACCOUNT_OPENING_BALANCE", "ACCOUNT_ACCOUNTS", "ACCOUNT_REPORTS"],
  PROJECT_MANAGER: ["ACCOUNT_DASHBOARD", "ACCOUNT_LEDGER_VIEW", "ACCOUNT_PROJECTS", "ACCOUNT_REPORTS"],
  DATA_ENTRY: ["ACCOUNT_DASHBOARD", "ACCOUNT_LEDGER_VIEW", "ACCOUNT_JOURNAL_DRAFT", "ACCOUNT_ACCOUNTS", "ACCOUNT_STOCK"],
};
