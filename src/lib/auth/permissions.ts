...
export const ACCOUNT_ROLE_PERMISSIONS: Record<AccountRole, readonly Permission[]> = {
  ...
  ACCOUNTANT: ["ACCOUNT_DASHBOARD", "ACCOUNT_QUOTATION_VIEW", "ACCOUNT_QUOTATION_EDIT", "ACCOUNT_QUOTATION_APPROVE", "ACCOUNT_QUOTATION_COST_VIEW", "ACCOUNT_QUOTATION_SHARE", "ACCOUNT_SALES_ENTRY", "ACCOUNT_PURCHASE_ENTRY", "ACCOUNT_SETTLEMENT_ENTRY", "ACCOUNT_LEDGER_VIEW", "ACCOUNT_JOURNAL_DRAFT", "ACCOUNT_JOURNAL_POST", "ACCOUNT_JOURNAL_REVERSE", "ACCOUNT_OPENING_BALANCE", "ACCOUNT_EXPENSE_VIEW", "ACCOUNT_EXPENSE_ENTRY", "ACCOUNT_MONEY_VIEW", "ACCOUNT_MONEY_ENTRY", "ACCOUNT_ACCOUNTS", "ACCOUNT_STOCK", "ACCOUNT_REPORTS"],
  PROJECT_MANAGER: ["ACCOUNT_DASHBOARD", "ACCOUNT_QUOTATION_VIEW", "ACCOUNT_QUOTATION_EDIT", "ACCOUNT_QUOTATION_APPROVE", "ACCOUNT_QUOTATION_COST_VIEW", "ACCOUNT_QUOTATION_SHARE", "ACCOUNT_LEDGER_VIEW", "ACCOUNT_PROJECTS", "ACCOUNT_PROJECT_COST_VIEW", "ACCOUNT_PROJECT_COST_EDIT", "ACCOUNT_EXPENSE_VIEW", "ACCOUNT_EXPENSE_ENTRY", "ACCOUNT_REPORTS"],
  DATA_ENTRY: ["ACCOUNT_DASHBOARD", "ACCOUNT_QUOTATION_VIEW", "ACCOUNT_QUOTATION_EDIT", "ACCOUNT_SALES_ENTRY", "ACCOUNT_PURCHASE_ENTRY", "ACCOUNT_LEDGER_VIEW", "ACCOUNT_JOURNAL_DRAFT", "ACCOUNT_ACCOUNTS"],
};
