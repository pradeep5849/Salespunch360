...
export const ACCOUNT_ROLE_PERMISSIONS: Record<AccountRole, readonly Permission[]> = {
  ...
  DATA_ENTRY: ["ACCOUNT_DASHBOARD", "ACCOUNT_QUOTATION_VIEW", "ACCOUNT_QUOTATION_EDIT", "ACCOUNT_SALES_ENTRY", "ACCOUNT_PURCHASE_ENTRY", "ACCOUNT_SETTLEMENT_ENTRY", "ACCOUNT_LEDGER_VIEW", "ACCOUNT_JOURNAL_DRAFT", "ACCOUNT_ACCOUNTS", "ACCOUNT_STOCK"],
};
