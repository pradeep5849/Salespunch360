...
export default function Home() {
 return <main className="public-site">
  ...
  <section className="hero"><div className="hero-copy"><p className="hero-kicker"><span/> Field force management, simplified</p><p className="hero-subtitle">Complete field force management for modern businesses</p><ul><li>Real-time attendance & GPS tracking</li><li>Customer check-in & check-out</li><li>Lead management & pipeline</li><li>Targets, performance & reports</li></ul><div className="hero-actions"><Link className="button" href="/register">Start Free Trial <span>→</span></Link><a className="button secondary" href="#demo">Book a Demo</a></div><p className="no-card">✓ 15-day trial &nbsp; • &nbsp; No credit card required</p></div>
