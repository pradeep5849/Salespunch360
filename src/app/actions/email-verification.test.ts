...
describe("verification actions",()=>{
 it("uses self-profile permission rather than legacy role authority",async()=>{await resendVerificationEmail({});expect(mocks.role).toHaveBeenCalledWith("PROFILE_SELF")});
