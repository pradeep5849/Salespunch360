...
export default async function AdminCompaniesPage({ searchParams }: { searchParams: Promise<{ deleted?: string }> }) {
  ...
  return <main className="admin-content">
    ...
    <div className="admin-title-row"><div><p className="eyebrow">Platform administration</p><h1>Companies</h1><p className="muted">Registered tenant identity and subscription status.</p></div><Link className="admin-primary-action" href="/admin/billing/orders">Billing</Link></div>
