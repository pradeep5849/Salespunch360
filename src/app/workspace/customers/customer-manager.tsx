...
export function CustomerManager({customers,canManage,assignees}:{customers:Customer[];canManage:boolean;assignees:{id:string;name:string;salesRole:string|null}[]}) {
 return <div>
