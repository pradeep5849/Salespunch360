...
export default async function Page(){
 ...
 return <main className="targets-content"><WorkspacePageHeader title="Sales Targets" backHref="/workspace"/>
  <p className="muted">Monthly targets run from the 1st to the last day of the month. Target numbers carry forward automatically; Check-ins and Leads Won actuals restart each month.</p>
  <div className="monthly-target-table"><div className="monthly-target-head"><span>Employee</span><span>Check-ins Target / Actual</span><span>Leads Won Target / Actual</span><span>Action</span></div>
