...
export default async function LeadsPage({searchParams}:{searchParams:Promise<Record<string,string|undefined>>}){
 ...
 return <main className="leads-shell"><header className="employees-header"><Link href="/workspace">← Workspace</Link><BrandLogo href="/workspace" /></header><section className="leads-content"><p className="eyebrow">Tenant-secure sales pipeline</p><h1>Leads</h1>
