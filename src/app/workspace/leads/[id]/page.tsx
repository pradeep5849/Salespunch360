...
export default async function LeadDetail({params,searchParams}:{params:Promise<{id:string}>;searchParams:Promise<{updated?:string}>}){
 ...
 return <main className="leads-shell"><section className="leads-content">
  ...
  {canManage&&<section id="delete-lead" className="activity delete-lead-section"><h2>Delete Lead</h2><p>Delete this lead only if it is no longer required. This action is permanent.</p><DeleteLead leadId={lead.id}/></section>}
