...
type Employee = {
  id: string; name: string; email: string; phone: string | null; employeeCode: string | null; travelAllowanceEnabled:boolean; travelRatePerKm:{toString():string}|null;
