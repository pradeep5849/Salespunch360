...
type Employee = {
  id: string; name: string; email: string; phone: string | null; employeeCode: string | null; travelAllowanceEnabled:boolean; travelRatePerKm:string|null;
  salesRole: SalesRole; managerType: ManagerType | null; isActive: boolean; managerId: string | null;
...
export function EmployeeManager({ employees, managers, managersEnabled, canAdd, canManageTravel }: { employees: Employee[]; managers: Employee[]; managersEnabled: boolean; canAdd: boolean; canManageTravel: boolean }) {
