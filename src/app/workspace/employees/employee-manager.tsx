...
type Employee = {
  ...
  role: Role; isActive: boolean; managerId: string | null;
...
export function EmployeeManager({ employees, managers, canAdd }: { employees: Employee[]; managers: Employee[]; canAdd: boolean }) {
  ...
  return (
    <div>
      <div className="employee-actions"><button disabled={!canAdd} onClick={() => setCreateRole("MANAGER")}>Add Manager</button><button disabled={!canAdd} onClick={() => setCreateRole("SALES")}>Add Sales employee</button></div>
