  ...
  return (
    <main className="workspace-shell">
      ...
      <section className="workspace-content">
        ...
        {user.role === "COMPANY_ADMIN" && <Link className="employees-link-card" href="/workspace/billing"><span>Subscription & billing</span><strong>Manage billing →</strong></Link>}
        ...
        {(user.role === "COMPANY_ADMIN" || user.role === "MANAGER" || user.role === "SALES") && <Link className="employees-link-card" href="/workspace/targets"><span>Performance goals</span><strong>Open targets →</strong></Link>}
        {(user.role === "COMPANY_ADMIN" || user.role === "MANAGER" || user.role === "SALES") && <Link className="employees-link-card" href="/workspace/reports"><span>Historical reporting</span><strong>Open reports →</strong></Link>}
        {trial?.isInTrial && (
