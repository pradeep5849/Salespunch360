...
export default async function Page(){
 ...
 return <main className="billing-content"><WorkspacePageHeader title="Billing & Subscription" backHref="/workspace"/>
  <p className="muted">Company Admin is free. Choose a billing period and the number of Manager and Sales seats.</p>
  ...
  <section className="billing-card"><h2>Choose your plan</h2><BillingCalculator managersEnabled={managersEnabled} managerUsage={e.managerUsage} salesUsage={e.salesUsage} prices={prices}/></section>
