...
export default async function Page(){
 ...
 return <main className="billing-content"><WorkspacePageHeader title="Add Sales Team" backHref="/workspace/billing/actions"/>
  {!r.hasSales||!e?<section className="billing-card"><h2>Sales subscription not available</h2><p className="muted">This company edition does not include Sales-team billing.</p><Link href="/workspace/billing/actions">← Back to Billing</Link></section>:
