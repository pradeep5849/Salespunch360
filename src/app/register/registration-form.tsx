...
export function RegistrationForm() {
  ...
  return <form action={formAction} className="registration-form">
    <input type="hidden" name="productEdition" value="SALESPUNCH360" />
    <div className="form-section"><div className="section-heading"><span>1</span><div><h2>SalesPunch360</h2><p>Field Sales &amp; CRM workspace</p></div></div><p className="muted">Start a 15-day trial of the production-ready SalesPunch360 product.</p></div>
