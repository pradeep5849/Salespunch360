...
type ShellProps={children:React.ReactNode;companyName:string;companyAddress?:string;hasCompanyLogo?:boolean;companyLogoVersion?:number;userName:string;role:string;isPlusPrimaryAdmin?:boolean;notifications:number;navigation:AccountNavGroup[];showItems:boolean;showProjects:boolean};
export function AccountShell({children,companyName,companyAddress,hasCompanyLogo=false,companyLogoVersion,userName,role,isPlusPrimaryAdmin=false,notifications,navigation,showItems,showProjects}:ShellProps){
