...
private fun masterKind(path:String)=when{path=="/workspace/account/customers"->"customers";path=="/workspace/account/vendors"->"vendors";path=="/workspace/account/inventory"||path=="/workspace/account/inventory/items"->"items";path=="/workspace/account/inventory/warehouses"->"warehouses";else->null}
