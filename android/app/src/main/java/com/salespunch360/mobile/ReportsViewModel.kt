...
data class ReportsState(val loading:Boolean=true,val type:String="attendance",val report:JsonObject?=null,val start:String="",val end:String="",val employeeId:String?=null,val customerId:String?=null,val status:String="ALL",val sentiment:String="ALL",val page:Int=1,val message:String?=null)
