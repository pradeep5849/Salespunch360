...
@Serializable data class ManualOrderRequest(val action:String="CREATE_MANUAL_ORDER",val paymentMethod:String="MANUAL",val kind:String="SALES",val billingPeriod:String,val adminSeats:Int=0,val managerSeats:Int=0,val salesSeats:Int=0,val retainAdminUserIds:List<String> = emptyList(),val retainManagerUserIds:List<String> = emptyList(),val retainSalesUserIds:List<String> = emptyList(),val idempotencyKey:String)
