...
class F3MCorrectionTest {
 ...
 @Test fun `authenticated JSON and multipart 401 invalidate session`(){var invalidations=0;invalidateOnUnauthorized(401){invalidations++};invalidateOnUnauthorized(401){invalidations++};invalidateOnUnauthorized(409){invalidations++};assertEquals(2,invalidations)}
